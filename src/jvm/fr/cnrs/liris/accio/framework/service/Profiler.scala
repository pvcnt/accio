...
import fr.cnrs.liris.accio.framework.api.thrift.Metric

import scala.collection.JavaConverters._

/**
 * Profile the execution of parts of code. These metrics will be included as part of the
 * [[fr.cnrs.liris.accio.framework.api.thrift.OpResult]] structure. It means they should respect the reproducibility principle,
