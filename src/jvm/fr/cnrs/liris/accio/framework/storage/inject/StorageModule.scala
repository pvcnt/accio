...
package fr.cnrs.liris.accio.framework.storage.inject

import com.google.inject.Module
import com.twitter.inject.{Injector, TwitterModule}
import fr.cnrs.liris.accio.framework.storage.Storage
import fr.cnrs.liris.accio.framework.storage.elastic.ElasticStorageModule
import fr.cnrs.liris.accio.framework.storage.memory.MemoryStorageModule
