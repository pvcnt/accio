...
import fr.cnrs.liris.accio.framework.discovery.{InvalidOpDefException, OpMeta, OpDiscovery}
 ...
 */
final class ReflectOpDiscovery extends OpDiscovery with LazyLogging {
