...
import fr.cnrs.liris.accio.core.storage.memory.{MemoryRunRepository, MemoryTaskRepository, MemoryWorkflowRepository}
import fr.cnrs.liris.accio.core.storage.{MutableRunRepository, MutableTaskRepository, MutableWorkflowRepository}
import net.codingwell.scalaguice.ScalaModule

/**
 * Guice module provisioning repositories with in-memory storage.
 */
final class MemoryStorageModule extends ScalaModule {
