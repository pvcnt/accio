...
object UploaderModule extends TwitterModule {
  private[core] val uploaderFlag = flag("uploader.type", "local", "Uploader type")
  private[core] val localUploaderPathFlag = flag[String]("uploader.local.path", "Path where to store files")
