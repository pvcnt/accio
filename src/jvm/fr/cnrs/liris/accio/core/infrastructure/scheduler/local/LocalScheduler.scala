...
package fr.cnrs.liris.accio.core.infrastructure.scheduler.local
...
/**
 * Local scheduler configuration parameters.
 *
 ...
 */
class LocalScheduler @Inject()(opRegistry: OpRegistry, downloader: DownloadClient)
  extends Scheduler with StrictLogging with Configurable[LocalSchedulerConfig] {
  ...
  // This is lazy to avoid accessing config before it is initialized.
