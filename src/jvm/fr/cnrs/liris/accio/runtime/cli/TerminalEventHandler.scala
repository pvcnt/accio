...
private[cli] case class TerminalEventHandlerOpts(
  @Flag(
...
private[cli] class TerminalEventHandler(outErr: OutErr, opts: TerminalEventHandlerOpts)
  extends EventHandler with LazyLogging {
