...
private[service] sealed trait Exploration {
  /**
 ...
 */
private[service] case class SingletonExploration(value: Any) extends Exploration {
 ...
 */
private[service] case class ListExploration(values: Set[Any]) extends Exploration {
 ...
 */
private[service] case class RangeExploration(from: Any, to: Any, step: Any, log: Boolean = false, log10: Boolean = false, log2: Boolean = false) extends Exploration with LazyLogging {
