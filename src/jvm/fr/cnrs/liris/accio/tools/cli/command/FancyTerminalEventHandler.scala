 ...
 */
private[cli] final class FancyTerminalEventHandler(outErr: OutErr, opts: TerminalEventHandlerOpts)
  extends TerminalEventHandler(outErr, opts) with LazyLogging {
