...
package fr.cnrs.liris.accio.discovery.reflect

import fr.cnrs.liris.accio.api.Values
import fr.cnrs.liris.accio.api.thrift._
import fr.cnrs.liris.accio.discovery.InvalidOpDefException
...
class ReflectOpDiscoverySpec extends UnitSpec {
  ...
  it should "detect unsupported data type" in {
    ...
    expected.getMessage shouldBe "Illegal definition of operator fr.cnrs.liris.accio.discovery.reflect.InvalidParamOp: Unsupported data type: scala.collection.Iterator"
  }
