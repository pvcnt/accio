...
import fr.cnrs.liris.accio.framework.storage.{MutableWorkflowRepository, WorkflowRepositorySpec}
...
class ElasticWorkflowRepositorySpec extends WorkflowRepositorySpec with ElasticRepositorySpec {
  ...
  override protected def createRepository: MutableWorkflowRepository = {
    ...
    new ElasticWorkflowRepository(mapper, client, s"accio${i.incrementAndGet}", Duration.Top)
  }
