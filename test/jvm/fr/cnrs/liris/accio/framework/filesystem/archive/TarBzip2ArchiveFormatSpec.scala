...
class TarBzip2ArchiveFormatSpec extends CompressedArchiveFormatSpec {
  ...
  override protected def singleFileArchivePath = "fr/cnrs/liris/accio/framework/filesystem/archive/single.tar.bz2"

  override protected def treeArchivePath = "fr/cnrs/liris/accio/framework/filesystem/archive/tree.tar.bz2"
