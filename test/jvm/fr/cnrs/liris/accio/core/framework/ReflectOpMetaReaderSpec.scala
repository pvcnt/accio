...
class ReflectOperatorMetaReaderSpec extends UnitSpec {
  ...
  it should "detect unsupported data type" in {
    ...
    expected.getMessage shouldBe "Illegal definition of operator fr.cnrs.liris.accio.core.framework.InvalidParamOp: Unsupported data type: scala.collection.Iterator"
  }
