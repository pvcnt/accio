...
class ZipArchiveFormatSpec extends CompressedArchiveFormatSpec {
  ...
  override protected def singleFileArchivePath = "fr/cnrs/liris/accio/filesystem/archive/single.zip"

  override protected def treeArchivePath = "fr/cnrs/liris/accio/filesystem/archive/tree.zip"
