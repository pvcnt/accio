 ...
 * placed into test/resources/fr/cnrs/liris/accio/scheduler.
 *
...
object AccioExecutorMain {
  def main(args: Array[String]): Unit = {
    println("I print something to stdout just to check it is correctly consumed")
    if (args.last != "fast_task_id") {
